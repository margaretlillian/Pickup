...
namespace Pickup.Data.Migrations
{
    ...
    [Migration("20180610020840_Rename_Tables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pickup.Models.ItemCategory", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Pickup.Models.ItemDonatedSold", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("ItemsDonatedSold");
                });

            modelBuilder.Entity("Pickup.Models.ItemsAndPickupOrDelivery", b =>
                {
                    b.Property<int>("PickupDeliveryID");

                    b.Property<int>("ItemID");

                    b.Property<string>("Description");

                    b.Property<int?>("ItemsDonatedSoldID");

                    b.Property<int>("Quantity");

                    b.HasKey("PickupDeliveryID", "ItemID");

                    b.HasIndex("ItemsDonatedSoldID");

                    b.ToTable("ItemsPickupsDeliveries");
                });
            ...
            modelBuilder.Entity("Pickup.Models.ItemDonatedSold", b =>
                {
                    b.HasOne("Pickup.Models.ItemCategory", "ItemCategory")
                        .WithMany("ItemsDonatedSold")
            ...
            modelBuilder.Entity("Pickup.Models.ItemsAndPickupOrDelivery", b =>
                {
                    b.HasOne("Pickup.Models.ItemDonatedSold", "ItemsDonatedSold")
                        .WithMany("ItemsPickupsDeliveries")
                        .HasForeignKey("ItemsDonatedSoldID");

                    b.HasOne("Pickup.Models.PickupOrDelivery", "PickupDelivery")
